 ...
 */
public class TouchOperateListActivity extends DataBindingActivity<ActivityTouchOperateListBinding> {
       ...
       // 先实例化Callback
        ...
        touchAdapter.setOnItemDataClickListener(new OnItemDataClickListener<TypeInterface>() {
            ...
            public void onItemClick(View view, TypeInterface item, int truePos, int relativePos) {
                ...
                Toast.makeText(TouchOperateListActivity.this, "truePos=" + truePos + ",位置relativePos=" + relativePos, Toast.LENGTH_SHORT).show();
            }
        });
